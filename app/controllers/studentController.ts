...
export class StudentController { 
    ...
    public updateStudent (req: Request, res: Response) { 
        StudentMongooseModel.findOneAndUpdate({ _id: req.body.studentId }, req.body, { new: true },
    ...
    public getCreateView (req: Request, res: Response){
        res.render("create",{
                });
    }

    public deleteStudent (req: Request, res: Response) {           
        StudentMongooseModel.findOneAndRemove({ _id: req.body.studentId }, (err, data) => {
            if (err){
                res.send(err);
            }
    ...
    public getDeleteStudent (req: Request, res: Response) {
        StudentMongooseModel.findById(req.params.studentId, (err, data) => {
            if (err){
                res.send(err);
            }
